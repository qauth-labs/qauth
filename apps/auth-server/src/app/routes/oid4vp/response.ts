  ...
  fastify.withTypeProvider<ZodTypeProvider>().post(
    ...
    async (request, reply) => {
      ...
      try {
        ...
        // request; validation (#234), issuer trust (#236) and subject resolution
        // (#300) all happen on that side, where the session and the asserted
        // identifier exist. Nothing about this endpoint's posture changed: it
        // still authenticates nobody, still creates nothing, and still cannot
        // name a browser, a user or an account.
