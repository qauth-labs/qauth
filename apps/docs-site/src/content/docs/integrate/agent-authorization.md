...
description: How an AI agent acts on behalf of a user — the is_agent client type, RFC 8693 token exchange, scope modes, step-up authentication, and per-agent audit.
sidebar:
  order: 6
...
[MCP Quickstart](/integrate/mcp-quickstart/) and [OAuth 2.1 Flow](/integrate/oauth-flow/) cover
...
[Token Exchange section of the OAuth 2.1 Flow guide](/integrate/oauth-flow/#token-exchange--agent-on-behalf-of-delegation-rfc-8693).
...
- [OAuth 2.1 Flow](/integrate/oauth-flow/) — the underlying endpoints with copy-paste
  `curl`, including the [Token Exchange](/integrate/oauth-flow/#token-exchange--agent-on-behalf-of-delegation-rfc-8693)
  section.
