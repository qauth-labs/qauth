...
description: Guides for using the QAuth developer portal and dashboard.
sidebar:
  order: 0
lastVerified: '2026-07-27'
---

This lane is for people using the QAuth developer portal — the TanStack Start application at
`apps/developer-portal` where a developer registers, verifies their email, logs in, and manages
