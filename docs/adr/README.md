...
| [004](./004-wallet-agnostic-federation.md)       | Wallet-Agnostic VC Federation via OID4VP                                             | Accepted    | 2026-03-11 |
...
one item is flagged as needing a human call. See
[ADR-009 § Drift re-check (2026-07-26)](./009-wallet-account-resolution.md#drift-re-check-2026-07-26)
and the [EUDI Regulatory Drift Log](../eudi-regulatory-drift-log.md).
