...
| OpenID4VP                                                      | 1.0 Final (2025-07-09)     | `latest`     | `2026-07-26`  | `2026-11-30` | Final; no revision since                                                     | `libs/server/federation/src/oid4vp`, `docs/adr/004-wallet-agnostic-federation.md`, `docs/conformance/requirements/oid4vp-1_0.json` |
| OpenID4VC HAIP                                                 | 1.0 Final (2025-12-24)     | `latest`     | `2026-07-26`  | `2026-11-30` | Final; the pinning document for two rows above                               | `libs/server/federation/src/profiles/verifier-profiles.ts`, `docs/conformance/requirements/haip-1_0.json`                          |
