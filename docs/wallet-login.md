...
nothing to match a presentation against — [ADR-009](./adr/009-wallet-account-resolution.md)
...
signature. That path is exercised by
`helpers/wallet-login-request.test.ts`.
