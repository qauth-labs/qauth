...
For detailed configuration options, see the [`@qauth/cache` README](../data-access/cache/README.md).
...
- [`@qauth/cache`](../data-access/cache/README.md): Core Redis utilities and connection management
- [`@qauth/fastify-plugin-db`](../fastify-plugin/db/README.md): Database plugin for Fastify
