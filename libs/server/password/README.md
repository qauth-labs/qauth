...
```typescript
import { createPasswordHasher, DEFAULT_PASSWORD_CONFIG } from '@qauth-labs/server-password';
```
...
- [`@qauth-labs/shared-validation`](../../shared/validation/README.md): Password strength validation
- [`@qauth-labs/server-config`](../config/README.md): Environment configuration and validation
